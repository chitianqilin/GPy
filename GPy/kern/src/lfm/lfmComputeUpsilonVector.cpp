 ...
 *  > mex lfmComputeUpsilonVector.cpp  Faddeeva.o
*/
...
void computeUpsilon(
  ...
  for(mwSize i = 0; i < rows; i++) {
    ...
    upsilonReal[i] = real(ans);
    upsilonComplex[i] = imag(ans);
  }
}
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  computeUpsilon(gamma, sigma2, t1, rows, upsilonReal, upsilonComplex);
}
